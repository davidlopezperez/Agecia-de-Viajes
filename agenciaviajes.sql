...
CREATE TABLE `testimoniales` (
  ...
  `testimonio` longtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`)
...
INSERT INTO `testimoniales` VALUES (1,'David','delp304@gmail.com',NULL),(2,'Dayana','dayanaqf@hotmail.com','Excelente'),(3,'Gladys','gladysth44@gmail.com','Lorem ipsum dolor, sit amet consectetur adipisicing elit. Architecto, quod. Fuga pariatur nulla corrupti. Laborum velit aut alias cumque praesentium, beatae porro perferendis culpa consectetur atque voluptatibus repudiandae eaque sed');
...
CREATE TABLE `viajes` (
  ...
  `disponibles` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2020-06-29 16:29:56
